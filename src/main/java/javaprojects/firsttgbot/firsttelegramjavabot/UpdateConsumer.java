...
public class UpdateConsumer implements LongPollingSingleThreadUpdateConsumer {
    ...
    public UpdateConsumer() {
        this.telegramClient = new OkHttpTelegramClient("8426677991:AAE1kpo2VEALUoaEHLDQ0kOzK39W-V0nd5g");
    }
    ...
    private void sendImage(Long chatId) {
        ...
        new Thread(() -> {
            var imageUrl = "https://avatars.mds.yandex.net/get-autoru-vos/4479447/1dd0eab102b1310d051c159978d7ba9d/1200x900";
            try {
